...
public class InventoryReservedMonitor
{
	...
	public async Task RunAsync([EventHubTrigger("%InventoryReservedEventHub%", Connection = "InventoryReservedConnectionString", ConsumerGroup = "notice")] EventData[] eventMessages)
	{
