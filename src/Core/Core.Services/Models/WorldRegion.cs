...
public partial class WorldRegion
{
    ...
    public virtual ICollection<Country> CountryWorldRegionCodeNavigation { get; set; } = new List<Country>();

    public virtual ICollection<Country> CountryWorldSubregionCodeNavigation { get; set; } = new List<Country>();
